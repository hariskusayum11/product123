      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          ...
          shape: const CircleBorder(
            side: BorderSide(color: Color.fromARGB(255, 0, 72, 255), width: 3), // Orange border
          ),
          child: const Icon(Icons.add, color: Color.fromARGB(255, 1, 166, 221), size: 40), // Larger icon
        ),
      ),
